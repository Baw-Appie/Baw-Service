...
module.exports = function (req, res) {
    if(req.user) {
      if(req.params.service == 1) {
        ...
        var select_option = ["mail_ok", "sms_ok", "kakao_ok", "tg_ok", "browser_ok", "lookup_ok"]
        var select_option_korean = ["후원 Mail 알림", "후원 SMS 알림", "후원 KakaoTalk 알림", "후원 Telegram 알림", "후원 Browser 알림", "후원 기록 조회 허용"]
        ...
        var savetojson = ["mail_ok", "sms_ok", "kakao_ok", "tg_ok", "browser_ok", "lookup_ok", "bouns","api_cmd","youtube", "disabled"]
